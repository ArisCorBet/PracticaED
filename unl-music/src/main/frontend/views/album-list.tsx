  ...
  const createAlbum = async () => {
    try {
      if (nombre.value.trim().length > 0) {
        await AlbumServices.createAlbum(nombre.value, fecha.value);
        ...
        Notification.show('No se pudo crear, complete los datos', { duration: 5000, position: 'top-center', theme: 'Error' });
      }
